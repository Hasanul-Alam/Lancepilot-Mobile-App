    ...
    <View className="flex-1 bg-white">
      <GestureHandlerRootView className=" bg-white">
        <ScrollView className="" contentContainerStyle={{ paddingBottom: 20 }}>
          <CommonHeader />
          <View className="">
            <View className="w-[95%%] h-[100px] mx-auto rounded-xl bg-black opacity-85 pb-3">
          ...
          {/* Chart */}
          <View className="items-center justify-center bg-white mt-10 w-full">
            <LineChart
              data={chartData}
          ...
          <View className="w-[95%] mx-auto">
            <View className="w-full h-auto bg-[#000] opacity-85 rounded-xl py-5">
